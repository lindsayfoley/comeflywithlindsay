...
<html class="no-js" lang="en" dir="ltr">
  <head>
	<title>Destinations | Come Fly With Lindsay | My Travel Blog</title>
			...
			<div class="large-12 column">
				<article>
					<div class="row">
						...
						<div class="large-6 column">
							<h5><a href="banff.php">Banff National Park, Canada</a></h5>
							...
							<a class="button small" href="experience.php">More About Banff</a>
						</div>
					</div>
					<hr>
					<div class="row">
						...
						<div class="large-6 column">
							...
							<a class="button small" href="experience.php">Read About Whistler</a>
						</div>
					</div>
					<hr>
					<div class="row">
						...
						<div class="large-6 column">
							<h5><a href="vancouver.php">Vancouver, Canada</a></h5>
							...
							<a class="button small" href="experience.php">More On Vancouver</a>
						</div>
					</div>				
				</article>
			</div>
