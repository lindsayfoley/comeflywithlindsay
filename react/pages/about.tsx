            ...
            <div className="large-12 column">
              <div className="row">
                ...
                <div className="large-6 column">
                  ...
                  <p>My day job is a <a href="https://lindsayfoley.co.uk" target="_blank">Web Developer</a> which has been priceless in creating and designing this site and allowing me to flex some skills! I intend to travel a LOT and utilise my creative and dev skills to create these travel guides featuring cool photography <span className="crossed-out">mainly of food I eat, mostly burgers</span> along the way.</p>
