...
export const details = {
  meta: {
    title: "How to Spend 2 Nights in Calgary",
    description: "My insiders guide to spending a couple of nights in Downtown Calgary in Alberta, Canada. Read my blog post to prepare for your short stay in Calgary.",
    ogImage: "/images/calgary/olympic-plaza-calgary.jpg"
  },
  excerpt: {
    description: "Typically used as a base before heading to the Canadian Rockies in Banff, Calgary\'s city centre is good for a quick getaway or a weekend break if you\'re looking for a quiet destination. It\'s divided into several neighbourhoods with good shopping centres, dining options, museums, as well as spas.",
