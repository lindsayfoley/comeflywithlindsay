...
export const details = {
  meta: {
    ...
    heading: "Highlights and Tips for a Long Weekend in Seville",
    description:
  ...
  excerpt: {
    description:
      "Seville, the sun-drenched capital of Andalusia, is a city that beautifully blends rich history, lively traditions, and top-notch cuisine. From the iconic Seville Cathedral to the impressive Plaza de España, this enchanting destination is ideal for an unforgettable city break or a long weekend away!",
    image: "/images/seville/plaza-de-espana-seville.jpg",
    alt: "The charming Plaza de España",
    cta: "Seville Holiday Guide",
    link: "seville",
    highlight: true,
  },
  nextPost: {
